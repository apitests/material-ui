...
var Menu = React.createClass({
  ...
  componentDidUpdate: function componentDidUpdate(prevProps) {
    var openChanged = prevProps.open !== this.props.open;
    var justOpened = openChanged && this.props.open;
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    var openChanged = nextProps.open !== this.props.open;
    var isOpening = openChanged && nextProps.open;
    var isClosing = openChanged && !nextProps.open;
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['autoWidth', 'children', 'desktop', 'listStyle', 'maxHeight', 'multiple', 'open', 'openDirection', 'selectedMenuItemStyle', 'style', 'value', 'valueLink', 'width', 'zDepth']);
    ...
    var newChildren = React.Children.map(children, (function (child) {
      ...
      if (open && menuItemIndex >= focusIndex - 1 && menuItemIndex <= focusIndex + cascadeChildrenCount - 1) {
      ...
      var clonedChild = childIsADivider || childIsDisabled ? child : _this._cloneMenuItem(child, menuItemIndex, styles);
  ...
  _cloneMenuItem: function _cloneMenuItem(child, childIndex, styles) {
    ...
    var isFocused = open && childIndex === this.state.focusIndex;
    var focusState = 'none';
    if (isFocused) {
    ...
    return React.cloneElement(child, {
      ...
      onKeyboardActivate: function onKeyboardActivate(e) {
        _this2.props.onItemKeyboardActivate(e, child);
